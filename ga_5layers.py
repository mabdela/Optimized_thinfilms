...
##wl_A, A = glass_ext[2:-25,0], glass_ext[2:-25,1]    #210nm to 2475nm
wl_A, A = glass_ext[6:-25,0], glass_ext[6:-25,1]    #230nm to 2475nm for AlN
Tg = 0.96
Rg = 0.04

def correct_TR(struct):
...
myConst=constants(lower_limit=390, upper_limit=700, T_factor=.55, R_factor=.45, max_DLC_thickness=300.0)
...
##    layer_five=DLC80WA(L5_thickness)
    ...
    return (priority, L1_thickness, L2_thickness, L3_thickness, L4_thickness, L5_thickness)
...
##    fifth=DLC80WA(arg[5])
    ...
    priority = myConst.R_factor*Reflectance + myConst.T_factor*Transmittance
    return (priority, arg[1], arg[2], arg[3], arg[4], arg[5])
...
'''
    ...
    child_one=parent_one[0:3]+parent_two[3:4]+(L4_thickness, L5_thickness)
    
    child_two=parent_two[0:3]+(L5_thickness, )+parent_one[4:]
        
    child_three=child_one[:1]+child_one[1:3]+child_one[5:]+child_one[4:5]+child_one[3:4]
    
    child_four=child_two[:1]+child_two[1:3]+child_two[5:]+child_two[4:5]+child_two[3:4]
