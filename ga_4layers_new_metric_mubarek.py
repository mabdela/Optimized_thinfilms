...
myConst=constants(lower_limit=390, upper_limit=700,
                  p1=1.2, p2=5, wanted_TSER=.7, max_DLC_thickness=80.0)
...
def create_structure():
 ...
 '''
    ...
    L1_thickness=random.uniform(3., 20.)
    ...
    layer_two=TiO2(L2_thickness)
        
    L3_thickness=random.uniform(3., 20.)
